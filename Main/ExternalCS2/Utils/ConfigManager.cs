...
public class ConfigManager
{
    ...
    public bool TriggerAutoStop { get; set; } = true;
    public bool EspVisibleCheck { get; set; } = true;
    public bool EspFilledBox { get; set; } = true;
    public bool AimLegitMode { get; set; } = true; // true — только видимые, false — сквозь стены
    public bool AimSilentFlick = false;
    // или public float AimSilentFlick = 0.0f; (в зависимости от того, как оно используется в строке 205)
    public Keys AimLegitToggleKey { get; set; } = Keys.None; // По умолчанию клавиша не назначена
